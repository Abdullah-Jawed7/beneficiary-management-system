...
import { changeCurrentPassword, deleteUser, getAllUsers, getCurrentUser, getUser, loginUser, registerUser, updateAccountDetails, updateUserAvatar } from "../controllers/user.controller.js";
...
userRouter.delete('/delete-user/:id' , verifyAdmin , deleteUser)
